...
//        Collections.shuffle(questionList);
        ...
        int typeId = it.getIntExtra("idtype",0);
        String typeName = it.getStringExtra("typename");
        textViewCategory.setText(typeName);

        QuizDbHelper dbHelper = new QuizDbHelper(this);
        questionList = dbHelper.getAllTypicalQuestions(typeId);
            ...
            public void onClick(View v) {
                ...
                if (!answered){
                    ...
                    if(btn1.isChecked() || btn2.isChecked() || btn3.isChecked() || btn4.isChecked()){
                        ...
                        Toast.makeText(TypeQuizActivity.this,"Hãy chọn đáp án",Toast.LENGTH_SHORT).show();
                    }
                }
                else {
//                    rbGroup.clearCheck();
    ...
    private void showBackwardConfirmationDialog() {
        ...
        builder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(TypeQuizActivity.this,TypeActivity.class);
